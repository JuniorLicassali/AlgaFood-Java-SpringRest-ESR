...
public class Problem {
	...
	@ApiModelProperty(example = "Um ou mais campos estão inválidos. Faça o preenchimentos correto e tente novamente.", position = 20)
	private String detail;
	
	@ApiModelProperty(example = "Um ou mais campos estão inválidos. Faça o preenchimentos correto e tente novamente.", position = 25)
